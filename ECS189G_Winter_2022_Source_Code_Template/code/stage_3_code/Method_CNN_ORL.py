...
class Method_CNN(method, nn.Module):
    ...
    def __init__(self, mName, mDescription):
        ...
        self.pool_layer2 = nn.MaxPool2d((2, 2), stride=2)
        self.flatten = nn.Flatten()

        self.fc_layer1 = nn.Linear(in_features=29184, out_features=100)
    ...
    def train(self, X, y):
      ...
      for epoch in range(self.max_epoch):  # you can do an early stop if self.max_epoch is too much...
          ...
          if epoch % 100 == 0:
              ...
              test_y_pred = self.forward(torch.FloatTensor(np.array(self.data['test']['X'])).permute(0,3,1,2))
